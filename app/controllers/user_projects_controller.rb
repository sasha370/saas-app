class UserProjectsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to users_tenant_project_url(id: @user_project.project.id, tenant_id: @user_project.project.tenant_id), notice: 'Пользователь был удален из вашего проекта' }
    end
  end
